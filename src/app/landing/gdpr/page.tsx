      ...
      <Container maxWidth="md">
        ...
        >
          <Box sx={{ textAlign: 'center', mb: 4 }}>
            <Security sx={{ fontSize: 48, color: 'var(--color-primary)', mb: 2 }} />
            <Typography
              variant="h3"
              sx={{
                fontWeight: 700,
          ...
          <Alert severity="info" sx={{ mb: 4 }}>
            <AlertTitle>{t('policies.gdpr.alert_title')}</AlertTitle>
            {t('policies.gdpr.alert_body')}
          </Alert>
          ...
          <Box sx={{ mb: 4 }}>
            <Typography variant="h5" sx={{ fontWeight: 600, mb: 3, color: 'var(--color-foreground)' }}>
                  ...
                  >
                    <CardContent sx={{ p: 3 }}>
                      <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                        {right.icon}
                        <Typography variant="h6" sx={{ ml: 1, fontWeight: 600, color: 'var(--color-foreground)' }}>
                          {right.title}
                        </Typography>
                      </Box>
                      <Typography variant="body2" sx={{ color: 'var(--color-muted)', lineHeight: 1.5 }}>
                        {right.description}
                      </Typography>
                    </CardContent>
                  </Card>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" sx={{ color: 'var(--color-muted)', lineHeight: 1.6, mt: 2 }}>
          ...
          <Box sx={{ textAlign: 'center' }}>
            <Typography variant="h6" sx={{ fontWeight: 600, mb: 2, color: 'var(--color-foreground)' }}>
              {t('policies.gdpr.dpo.title')}
            </Typography>
            <Typography variant="body1" sx={{ color: 'var(--color-muted)', lineHeight: 1.6 }}>
              {t('policies.gdpr.dpo.body')}
              <br />
              <strong>{t('policies.common.email')}</strong> gdpr@poolzapp.com
              <br />
